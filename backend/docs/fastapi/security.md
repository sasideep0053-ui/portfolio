...
Several of these flows are appropriate for building an OAuth 2.0 authentication provider (like Google, Facebook, X (Twitter), GitHub, etc): implicit clientCredentials authorizationCode
implicit
clientCredentials
authorizationCode
