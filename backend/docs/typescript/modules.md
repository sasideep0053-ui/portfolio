...
```
ts function absolute ( num : number ) { if ( num < 0 ) return num * - 1 ; return num ; } module . exports = { pi : 3.14 , squareTwo : 1.41 , phi : 1.61 , absolute , }; Try
```

Then these files can be imported via a require statement:

```
ts const maths = require ( "./maths" ); maths . pi ; any Try
```

Or you can simplify a bit using the destructuring feature in JavaScript:

```
ts const { squareTwo } = require ( "./maths" ); squareTwo ; const squareTwo: any Try
```
